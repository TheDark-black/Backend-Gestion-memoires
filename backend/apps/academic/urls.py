...
urlpatterns = [
    ...
    path('academic-years/', AcademicYearAPIView.as_view(), name='year-store'),
    ...
    path('academic-years/<uuid:pk>/', AcademicYearAPIView.as_view(), name='year-delete'),

    # Route pour lister toutes les années academique enregister :
    path('academic-years/obtenir', AcademicYearAPIView.as_view(), name='year-list-get'),
]