...
urlpatterns = [
    ...
    path('subjects/store/', SubjectAPIView.as_view(), name='subject-store'),
    ...
    path('subjects/delete/<uuid:pk>/', SubjectAPIView.as_view(), name='subject-delete'),
    
    # Route pour lister toutes les sujet enregistrer
    path('subjects/', SubjectAPIView.as_view(), name='subject-list-get'),
